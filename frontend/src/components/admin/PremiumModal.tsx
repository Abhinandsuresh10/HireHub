...
import { addPremiumPlan } from "../../api/admin/premium";
...
const PremiumModal = ({ onClose }: { onClose: () => void }) => {
    ...
    const handleSubmit = async () => {
        ...
        const response = await addPremiumPlan({ formData });
        if (response.data) {
    ...
    return (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50">
            <div className="bg-white w-full max-w-md p-6 rounded-xl shadow-2xl">
                <h2 className="text-xl font-semibold text-gray-800 mb-4">Add Premium Plan</h2>
