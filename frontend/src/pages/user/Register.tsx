        ...
        <div className="bg-white min-h-screen flex items-center justify-center p-8">
            <div className="w-full max-w-4xl flex flex-col md:flex-row bg-white shadow-2xl rounded-lg overflow-hidden">
                ...
                <div className="md:w-1/2 p-6 flex flex-col justify-center">
                    <h2 className="text-2xl font-bold text-center text-gray-800 mb-6">Register to HireHub</h2>
                    ...
                    <form className="space-y-4" onSubmit={handleSubmit(onSubmit)}>
                       ...
                       {step === 1 && ( <><div>
                        ...
                        {step === 2 && (<button type="submit" className="w-full bg-yellow-500 text-white px-6 py-3 rounded-lg text-lg hover:bg-yellow-700">
                            Register
                        </button>)}
                        {step === 1 && (
                            <button type="button" onClick={handleNextStep} className="w-full bg-yellow-700 text-white px-6 py-3 rounded-lg text-lg hover:bg-yellow-700">
                                step 2
                            </button>
                        )}

                        <p className="text-gray-700">Already have an account? <Link to="/login" className="text-black">Login</Link></p>
                    </form>
